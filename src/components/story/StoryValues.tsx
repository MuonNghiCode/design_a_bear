        ...
        <div className="story-panel mb-12 md:mb-14">
          <h2 className="text-3xl md:text-4xl font-black text-[#17409A]">
            <span className="story-chapter-title story-reveal-wrap block overflow-hidden">
              <span className="story-reveal-line block">Chương 03 - Những điều chúng tôi bảo vệ</span>
            </span>
          </h2>
          <p className="mt-3 text-[#6B7280] text-base md:text-lg max-w-3xl">
            Trước khi là một sản phẩm công nghệ, Design a Bear là một người bạn của trẻ.
            Vì vậy mọi quyết định thiết kế đều bắt đầu từ giá trị giáo dục và tính nhân văn.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-5 md:gap-6 items-start">
          ...
          {STORY_VALUES.map((value) => (
            ...
            >
              ...
              <h3 className="mt-4 text-xl font-black text-[#1A1A2E]">{value.title}</h3>
          ...
          <aside className="story-panel rounded-3xl border border-[#E5E7EB] bg-white p-6 md:p-8 shadow-lg lg:sticky lg:top-32">
            <p className="text-xs uppercase tracking-[0.18em] text-[#9CA3AF] font-bold">Trích đoạn</p>
            ...
            <p className="mt-4 text-sm md:text-base text-[#6B7280] leading-relaxed">
              Chúng tôi thiết kế sản phẩm để bé có thể hỏi nhiều hơn, cười nhiều hơn
              và học theo cách tự nhiên nhất, với sự đồng hành chặt chẽ từ phụ huynh.
            </p>
          </aside>
        </div>
        </div>
