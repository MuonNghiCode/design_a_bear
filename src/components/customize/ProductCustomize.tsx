  ...
  return (
    <section ref={sectionRef} className="py-24 bg-[#F4F7FF] overflow-hidden">
      <div className="max-w-screen-2xl mx-auto px-8 md:px-16">
        {/* ── Back button ── */}
        <div className="customize-header mb-8">
          <button
            type="button"
            onClick={() => router.back()}
            className="flex items-center gap-2 text-sm font-bold text-[#6B7280] hover:text-[#17409A] transition-colors duration-150 cursor-pointer group"
          >
            <svg
              width="18"
              height="18"
