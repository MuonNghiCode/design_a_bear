            ...
            <div className="max-w-3xl">
              <h2 className="text-3xl md:text-4xl font-black leading-tight">
                <span className="story-chapter-title story-reveal-wrap block overflow-hidden">
                  <span className="story-reveal-line block">Chương 04 - Lời hứa từ Design a Bear</span>
                </span>
              </h2>
              <p className="mt-3 text-white/80 text-base md:text-lg">
                Chúng tôi tiếp tục đầu tư vào nội dung học tập, nâng cấp AI và xây dựng
                công cụ để phụ huynh dễ dàng đồng hành cùng con mỗi ngày.
              </p>
            </div>
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-4">
            {STORY_PROMISES.map((item) => (
              ...
              >
                ...
                <p className="mt-2 text-sm text-white/80 leading-relaxed">{item.detail}</p>
              </article>
            ))}
          </div>
        </div>
